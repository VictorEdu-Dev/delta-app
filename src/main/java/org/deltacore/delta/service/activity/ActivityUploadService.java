...
public class ActivityUploadService {
    ...
    public ActivityUploadService(
        ...
        this.BUCKET_NAME = gcpConfig.getBucketName();
        this.FOLDER_PATH = gcpConfig.getFolderPath();
        this.FOLDER_PATH_IMG = gcpConfig.getFolderPathImage();
        this.FOLDER_PATH_DOC = gcpConfig.getFolderPathDoc();
